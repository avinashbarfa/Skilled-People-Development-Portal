	...
	<div class="institute-nav">
		<div class="container">
			...
			<div id="searchLabour" class="tabcontent">
				<div class="col-md-12">
					<h3 style="text-align: center; color: darkcyan;">Search
						Labours For Your Work To Be Done</h3>
				</div>
			...
			<div id="viewLabour" class="tabcontent">
				...
				<form action="SearchLabour" method="POST">
					...
					<div class="col-md-2">
						<select name="search-as" id="search" style="width: 160px"
	...
	<div class="footer">
		<div class="container">
			...
			<div class="social-link">
				...
				<a href="https://www.facebook.com/SkillIndiaOfficial/"
					class="fa fa-facebook"></a> <a
					href="https://twitter.com/MSDESkillIndia" class="fa fa-twitter"></a>
			</div>
			<hr>
